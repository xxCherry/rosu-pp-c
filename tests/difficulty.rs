    ...
    test_cases! {
        Osu: OSU {
            NM => {
                ...
                aim_difficult_slider_count: 180.33980678704015,
                speed: 2.5263145770639976,
                flashlight: 0.0,
                slider_factor: 0.9847225384137204,
                aim_top_weighted_slider_factor: 1.399633254032127,
            ...
            HR => {
                ...
                aim_top_weighted_slider_factor: 1.3634873114118238,
                speed_top_weighted_slider_factor: 0.6668815233244475,
                speed_note_count: 185.01178339020348,
                aim_difficult_strain_count: 112.28112750203015,
            ...
            DT => {
                ...
                aim_top_weighted_slider_factor: 1.0,
